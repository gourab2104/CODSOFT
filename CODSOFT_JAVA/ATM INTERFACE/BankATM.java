...
class UserBankAccount {
    ...
    private final double MIN_BALANCE = 700;

    public UserBankAccount(double balance) {
        if (balance >= MIN_BALANCE) {
            this.balance = balance;
        } else {
            System.out.println("Initial balance must be at least $700. Setting balance to $700.");
...
public class BankATM {
    ...
    public BankATM(UserBankAccount userAccount) {
    ...
    public static void main(String[] args) {
        UserBankAccount userAccount = new UserBankAccount(2000);  // Initial balance of $1000
        BankATM bankATM = new BankATM(userAccount);
        bankATM.run();
    }
}
